...
print("CH Corporations - Sistema de Dados Master (Sincronizado V2 c/ Entregador + CH-OS)")
...
-- Lobby (Encontros): força salvar inventário/atributos antes do teleporte para o mapa de corrida
